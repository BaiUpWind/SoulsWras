...
namespace ThermoGroupSample
{
    ...
    public interface IMagDevice
    {
	    ...
	    bool StartProcessImage(GroupSDK.OUTPUT_PARAM param, GroupSDK.DelegateNewFrame funcFrame, uint dwStreamType, uint dwUserData);
	    bool StartProcessPulseImage(GroupSDK.OUTPUT_PARAM param, GroupSDK.DelegateNewFrame funcFrame, uint dwStreamType, uint dwUserData);
	    ...
	    bool LoadDDT(GroupSDK.OUTPUT_PARAM param, [MarshalAs(UnmanagedType.LPWStr)] string sFileName, GroupSDK.DelegateNewFrame funcFrame, uint intUserData);
    ...
    public class MagDevice : IMagDevice
    {
	    ...
	    public bool StartProcessImage(GroupSDK.OUTPUT_PARAM param, GroupSDK.DelegateNewFrame funcFrame, uint dwStreamType, uint dwUserData)
        {
            return GroupSDK.MAG_StartProcessImage(m_intChannelIndex, ref param, funcFrame, dwStreamType, dwUserData);
        }
