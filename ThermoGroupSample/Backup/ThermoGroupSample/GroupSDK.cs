...
namespace SDK
{
    public class GroupSDK
    {
        ...
        ///<summary>
        ///播放回调
        ///void CALLBACK NewFrame(UINT intChannelIndex, int intCameraTemperature, DWORD dwFFCCounterdown, DWORD dwCamState, DWORD dwStreamType, DWORD dwUserData);
        ///</summary>
        /// <param name="intChannelIndex">表示相机通道号</param>
        /// <returns></returns>
        public delegate void DelegateNewFrame(uint hDevice, int intCamTemp, int intFFCCounter, int intCamState, int intStreamType, int intUserData);
        ...
        ///<summary>
        ///开始传输红外数据
        ///_stdcall BOOL MAG_StartProcessImage(UINT intChannelIndex, const OutputPara * paraOut, MAG_FRAMECALLBACK funcFrame, DWORD dwStreamType, DWORD dwUserData);
        ///</summary>
        /// <param name="intChannelIndex">相机对应的通道号</param>
        ...
        public static extern bool MAG_StartProcessImage(uint hDevice, ref OUTPUT_PARAM outputParam, DelegateNewFrame newFrame, uint intStreamtype, uint intUserData);
	...
	/// <param name="intBufferSize"></param>
        ...
        /// <summary>
        /// 加载DDT文件
        /// BOOL MAG_LoadDDT(UINT intChannelIndex, OutputPara * paraOut, const WCHAR * charFilename, MAG_FRAMECALLBACK funcFrame, DWORD dwUserData);
        /// </summary>
        /// <param name="hDevice"></param>
        ...
        public static extern bool MAG_LoadDDT(uint hDevice, ref OUTPUT_PARAM param, [MarshalAs(UnmanagedType.LPWStr)] string sFileName, DelegateNewFrame newFrame, uint intUserData);
        ...
        /// <summary>
        /// 开始脉冲传输
        /// BOOL MAG_StartProcessPulseImage(UINT intChannelIndex, const OutputPara * paraOut, MAG_FRAMECALLBACK funcFrame, DWORD dwStreamType, DWORD dwUserData);
        /// </summary>
        /// <param name="hDevice"></param>
        ...
        public static extern bool MAG_StartProcessPulseImage(uint hDevice, ref OUTPUT_PARAM outputParam, DelegateNewFrame newFrame, uint intStreamtype, uint intUserData);
